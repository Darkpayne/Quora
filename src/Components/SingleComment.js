                ...
                <div className="">
                    ...
                    <div id='controls' className="py-2 flex justify-between">
                        ...
                        <div class="inline-flex rounded-full ">
                            <a href="#" class="py-1 px-4 text-sm font-medium text-gray-900 bg-white border-t border-b border-l rounded-l-full border-gray-200 hover:bg-gray-100 hover:text-blue-700  focus:text-blue-700 flex">
                                <div className='-rotate-90'><span className='text-lg flex'><ion-icon name="arrow-redo-outline"></ion-icon></span></div> 24
                            </a>
                            <a href="#" class="py-1 px-4 text-sm font-medium text-gray-900 bg-white rounded-r-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:text-blue-700">
