...
const SinglePost = ({post}) => {
  ...
  // fetches the comments of each post
      ...
      <main className='my-3 bg-white border'>
        <div className="relative">
            <div className="flex items-center px-4 pt-4">
              ...
              <div className="grow">
                  <h6 className='text-sm font-semibold capitalize'>{post?.title} {user?.user?.id === post?.user_id || <span onClick={followUser} className='text-sm text-blue-500 cursor-pointer'>∙ Follow</span>}</h6>
