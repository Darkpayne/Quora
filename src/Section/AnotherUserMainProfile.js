                       ...
                       <div className="my-1">
                        ...
                        {isLoading ?  <Skeleton /> :
                         <div className='flex space-x-1'>
                            <span onClick={followUser} className='cursor-pointer text-sm mt-2 flex items-center justify-center py-1 bg-blue-600 text-white px-3 rounded-full space-x-1'>
